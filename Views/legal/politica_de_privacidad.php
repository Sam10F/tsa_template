...
$other_purposes = 'Company porpuses';
?>

<section id="pdp-section" class="extra-padding">
    <p class="title">1. Política de privacidad</p>
    <p class="content">
    <?= COMPANY_NAME ?> informa a los usuarios del sitio web sobre su política respecto del tratamiento y
    ...
    En este sentido, <?= COMPANY_NAME ?> garantiza el cumplimiento de la normativa vigente en materia de
    ...
    <p class="title">2. Recogida, finalidad y tratamientos de datos </p>
    <p class="content">
    <?= COMPANY_NAME ?> tiene el deber de informar a los usuarios de su sitio web acerca de la recogida de
    ...
    anteriormente descritos.<br><br>
    A su vez <?= COMPANY_NAME ?> informa a los usuarios de que la finalidad del tratamiento de los datos
    ...
    finalidades como: <?= $other_purposes ?>
    ...
    Todos los datos personales, que sean recogidos a través del sitio web de <?= COMPANY_NAME ?>, y por
    tanto tenga la consideración de tratamiento de datos de carácter personal, serán incorporados en
    los ficheros declarados ante la Agencia Española de Protección de Datos por <?= COMPANY_NAME ?>.
    </p>
    <p class="title">3. Comunicación de información a terceros</p>
    <p class="content">
    <?= COMPANY_NAME ?> informa a los usuarios de que sus datos personales no serán cedidos a terceras
    ...
    tercero cuando <?= COMPANY_NAME ?> disponga del consentimiento expreso del usuario.
    </p>
    <p class="title">4. Derechos de los usuarios</p>
    <p class="content">
    ...
    En tanto en cuanto los datos del usuario son objeto de tratamiento por parte de <?= COMPANY_NAME ?>. Los
    ...
    la siguiente dirección: <?= COMPANY_NAME ?>, <?= $company_address ?> o
    ...
    de solicitud, el domicilio y los datos acreditativos.<br><br>
